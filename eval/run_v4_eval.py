...
def evaluate_question(
    ...
    """
    Evaluate V4 retrieval for one golden question.
    ...
    expected_document = question_data[
        "reference_document"
    ]
    ...
    #
    # V4 retrieves separately for each sub-question,
    # but our existing metrics expect a single list.
    retrieved_documents = []
